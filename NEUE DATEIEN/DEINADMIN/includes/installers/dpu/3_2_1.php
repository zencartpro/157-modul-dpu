 ...
 * @version $Id: 3_2_1.php 2022-10-25 16:13:51Z webchills $
 */
...
('DPU - Show sidebox currency symbols', 'DPU_SHOW_SIDEBOX_CURRENCY_SYMBOLS', 'true', 'Show currency symbols in the sidebox (when displayed).<br /><br />Default: true', @gid, 9, now(), now(), NULL, 'zen_cfg_select_option(array(\'true\', \'false\'),'),
...
('DPU - Währungssymbole in der Sidebox anzeigen?', 'DPU_SHOW_SIDEBOX_CURRENCY_SYMBOLS', '<br />Sollen in der DPU Sidebox Währungssymbole angezeigt werden?<br />', 43),
